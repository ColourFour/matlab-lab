/* Learning-path catalog. Prerequisite locks are handled by courses.js. */
window.LAB_PROJECTS = [
  { id: 'projectile-motion', number: '01', title: {en:'Projectile motion',zh:'抛体运动'}, summary:{en:'Launch it. Model it.',zh:'发射、建模，探索轨迹。'}, icon:'plot', available:true },
  { id: 'probability', number: '02', title: {en:'Beat the casino',zh:'挑战概率'}, summary:{en:'Explore chance with code.',zh:'用代码探索随机与概率。'}, icon:'target', available:true },
